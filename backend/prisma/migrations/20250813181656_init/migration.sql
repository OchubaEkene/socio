...
-- CreateEnum
CREATE TYPE "StaffType" AS ENUM ('permanent', 'temporary');
...
-- AddForeignKey
ALTER TABLE "availabilities" ADD CONSTRAINT "availabilities_staffId_fkey" FOREIGN KEY ("staffId") REFERENCES "staff"("id") ON DELETE CASCADE ON UPDATE CASCADE;
